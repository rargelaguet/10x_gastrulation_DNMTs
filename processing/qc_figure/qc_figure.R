...
classes.to.plot <- c("E8.5_WT", "E8.5_Dnmt3aKO_Dnmt3bWT", "E8.5_Dnmt3aWT_Dnmt3bKO", "E8.5_Dnmt3aKO_Dnmt3bKO", "E8.5_Dnmt1KO")
...
to.plot <- qc.dt[class%in%classes.to.plot]
to.plot.jitter <- to.plot %>% .[sample.int(n=nrow(.), size=nrow(.)/3)]
...
pdf(file.path(io$outdir,"qc_metrics_boxplot.pdf"), width=14, height=5)
print(p)
dev.off()
