...
# I/O
io$outdir <- file.path(io$basedir,"results/individual_genes/pseudobulk/per_sample/germline"); dir.create(io$outdir, showWarnings = F)
...
genes.to.plot <- c("Dazl","Fkbp6","Tex19.1")

for (i in genes.to.plot) {
  pdf(sprintf("%s/%s_barplot_pseudobulk_per_sample.pdf",io$outdir,i), width=8, height=4)
