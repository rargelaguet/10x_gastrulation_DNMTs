...
# I/O
io$outdir <- file.path(io$basedir,"results_all/individual_genes/pseudobulk/per_sample"); dir.create(io$outdir, showWarnings = F)
...
# genes.to.plot <- fread("/Users/argelagr/data/10x_gastrulation_DNMTs/results_all/differential/Dnmt1_KO/Neural_crest_WT_vs_Dnmt1_KO.txt.gz") %>% .[padj_fdr<0.01 & abs(logFC)>1.5,gene]
