...
# p <- DimPlot(seurat, label = FALSE, reduction = 'umap', pt.size=2) + 
p <- DimPlot(seurat, label = FALSE, reduction = 'umap', cols = opts$celltype.colors, pt.size=1) +
  NoLegend() +
  theme(
...
FeaturePlot(seurat, features = genes.to.plot, reduction='umap', pt.size=2)
